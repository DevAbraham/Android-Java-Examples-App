...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng cosoleacaque = new LatLng(17.996529 , -94.636873);

        mMap.setMinZoomPreference(10);
        mMap.setMaxZoomPreference(18);

        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in Sydney"));
        mMap.addMarker(new MarkerOptions().position(cosoleacaque).title("Heroica Cosoleacque").draggable(true));
        ...
        //mMap.moveCamera(CameraUpdateFactory.newLatLng(cosoleacaque));
